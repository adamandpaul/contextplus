...
class TestCollectionSet(TestCase):
    ...
    def test_attributes(self):
        self.assertEqual(self.collection.get_meta_title(), 'Collection of objects of type MyCollectionItems')
    ...
    def test_criteria_from_wtforms_collection_criteria(self):
        self.assertEqual(self.collection.criteria_from_wtforms_collection_criteria(None), [])
