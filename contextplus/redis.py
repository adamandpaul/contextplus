...
class DomainRedisNamespace(base.DomainBase):
    ...
    The usecase for this kind of object is for structures which
    don't need to be permenant and can be recovered without
    ...
    def obj_load(self, buf: bytes):
        """De-serialize bytest from the obj hash into a python object"""
    ...
    def obj_get(self, key: str):
        """Retreive an object stored in the obj hash at the key name"""
    ...
    def obj_dict_get(self, *keys) -> dict:
        """Get a series of objes stored as a dictionary"""
